...
export default function Banner() {
  ...
  return (
    <div
      className={`sticky bottom-0 right-0 left-0 isolate z-50 flex items-center overflow-hidden px-3.5 py-2.5 backdrop-blur-sm  md:px-6`}
    >
      <div
      ...
      <p
        className={`mx-auto text-sm leading-4 sm:leading-6 dark:text-gray-300 text-gray-900`}
      >
