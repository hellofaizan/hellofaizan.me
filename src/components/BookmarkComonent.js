...
const BookmarkComonent = ({ id, url, bookmark }) => {
    ...
    return (
        <div className={cn(
            ...
            <Link className='flex items-center justify-between gap-x-2' href={url} target='_blank'>
                <div className='flex flex-row gap-x-2'>
                    <Image src={`https://icons.duckduckgo.com/ip3/${hostname}.ico`} alt={hostname} width={46} height={46} />
                    <div className='flex flex-col'>
                        <h1 className='font-semibold text-base sm:text-xl text-gray-800'>{title}</h1>
